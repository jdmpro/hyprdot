...
if hostnamectl | grep -q 'Chassis: desktop'; then
    ...
    rm -r "$HOME/.config/waybar/configs/[TOP] Default Laptop" "$HOME/.config/waybar/configs/[TOP & BOT] SummitSplit" 2>&1 | tee -a "$LOG"
    ...
    rm -r "$HOME/.config/waybar/configs/[TOP] Default" "$HOME/.config/waybar/configs/[TOP & BOT] SummitSplit" 2>&1 | tee -a "$LOG"
